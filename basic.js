...
console.log(soyName, soyNumber, soyBoolean, soyNull, soyUndefined)

let dog = {name: 'Jambu', apellido:'Da Silva', edad: 4, lenguaje: 'perruno'};
console.log(dog)

let coders = ['Miriam', 'Larissa', 'Sulma', 'Carolina', 'Fabiola'];
console.log(coders)
...
const coder = {nombre:"Mafalda", edad: 4}
console.log(coder)
...
console.log(typeof soyName);
console.log(typeof soyNumber);
console.log(typeof soyBoolean);
console.log(typeof soyNull);
console.log(typeof soyUndefined);
...
let multiplique = number1*number2;
...
let comparation = (numero1==numero2);
...
let comparationTrue = (numero1<numero2);
console.log(comparationTrue);
...
let completName = (varName + " " + varSurname);
